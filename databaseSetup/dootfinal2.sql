...
INSERT INTO `staff` VALUES ('abc1','Janet Dubinsky','d3751d33f9cd5049c4af2b462735457e4d3baf130bcbb87f389e349fbaeb20b9'),('abc2','Allie Greenidge','d3751d33f9cd5049c4af2b462735457e4d3baf130bcbb87f389e349fbaeb20b9'),('abc3','Donetta Sievert','d3751d33f9cd5049c4af2b462735457e4d3baf130bcbb87f389e349fbaeb20b9'),('abc4','Oma Fraire','d3751d33f9cd5049c4af2b462735457e4d3baf130bcbb87f389e349fbaeb20b9'),('abc5','Marie smith','d3751d33f9cd5049c4af2b462735457e4d3baf130bcbb87f389e349fbaeb20b9'),('abc6','hector smith','d3751d33f9cd5049c4af2b462735457e4d3baf130bcbb87f389e349fbaeb20b9'),('abc7','harry king','d3751d33f9cd5049c4af2b462735457e4d3baf130bcbb87f389e349fbaeb20b9');
...
CREATE TABLE `subject` (
  ...
  CONSTRAINT `subject_ibfk_2` FOREIGN KEY (`section`) REFERENCES `schedule` (`SECTION`),
  CONSTRAINT `subject_ibfk_3` FOREIGN KEY (`ID`) REFERENCES `staff` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `subject` VALUES ('abc1','CNS','A'),('abc2','ME','A'),('abc3','CNS','A'),('abc4','ME','A'),('abc5','CNS','A'),('abc6','DBMS','A'),('abc7','UNIX','A'),('abc1','ADP','B'),('abc2','ATCI','B'),('abc3','ADP','B'),('abc3','UNIX','B'),('abc4','CNS','B'),('abc5','ADP','B'),('abc6','ATCI','B'),('abc7','DBMS','B'),('abc1','UNIX','C'),('abc2','DBMS','C'),('abc3','ATCI','C'),('abc4','DBMS','C'),('abc5','ME','C'),('abc6','UNIX','C'),('abc7','CNS','C');
...
-- Dump completed on 2020-12-22 14:17:49
